  ...
  return (
    <div className="bg-white">
      <div className="bg-white rounded-lg shadow p-8 w-full">
        <h2 className="text-2xl rounded-md font-semibold text-center mb-8 p-4 border border-gray-300">POST YOUR AD</h2>
        ...
        <form onSubmit={handleSubmit} className="space-y-8 w-1/2">
          ...
          <section>
            ...
            <div className="mb-4">
              <input
                ...
                required
              />
              <div className="text-xs text-gray-400 text-right mt-1">{title.length}/{MAX_TITLE}</div>
            </div>
            <div>
              <textarea
                className="w-full border rounded px-3 py-2 text-gray-700"
                ...
                required
              />
              <div className="text-xs text-gray-400 text-right">{desc.length}/{MAX_DESC}</div>
            </div>
          </section>
          ...
          <section>
            ...
            <div className="grid grid-cols-5 gap-2 mb-2">
              ...
              {photos.map((file, idx) => (
                <div key={idx} className="relative h-20 w-20 border border-gray-200 rounded overflow-hidden bg-gray-100 flex items-center justify-center">
                  <img
              ...
              {Array.from({ length: MAX_PHOTOS - photos.length - 1 }).map((_, i) => (
                <div
                  key={i}
